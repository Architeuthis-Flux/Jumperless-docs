...
Defines both dark and light themes with specific colors for Jumperless-specific tokens.
"""
...
# Import our custom token types
from .jumperless_lexer import JumperlessTokens

class JumperlessStyle(Style):
    """
    A dark color scheme for Jython (Jumperless Python) inspired by Dracula theme
    with vibrant colors for Jumperless-specific keywords and functions.
    """
    ...
    styles = {
        ...
        JumperlessTokens.JumperlessFunction:    'bold #f400ff',     # Pink for Jumperless functions
        JumperlessTokens.JumperlessConstant:    'bold #f300ff',     # Purple for Jumperless constants
        JumperlessTokens.JumperlessType:        'bold #3aff00',     # Yellow/green for Jumperless types
        JumperlessTokens.JFSFunction:           'bold #ff004d',     # Reddish pink for JFS functions
        JumperlessTokens.JFSConstant:           'bold #d9ff00',     # Cyan for JFS constants
        JumperlessTokens.HardwareConstant:      'bold #f300ff',     # Different purple for hardware constants
    }

class JumperlessLightStyle(Style):
    """
    ...
    styles = {
        ...
        JumperlessTokens.JumperlessFunction:    'bold #198754',     # Dark green for Jumperless functions
        JumperlessTokens.JumperlessConstant:    'bold #dc3545',     # Dark red for Jumperless constants
        JumperlessTokens.JumperlessType:        'bold #5300ff',     # Dark cyan for Jumperless types
